...
standardized_continuous_features = scaler.transform(np.array([continuous_features]))
features_for_prediction = np.concatenate([standardized_continuous_features, np.array(categorical_features).reshape(1, -1)], axis=1)
