...
if predicted_class == 1:
    shap.force_plot(explainer_shap.expected_value[1], shap_values[:, :, 1], pd.DataFrame(features_for_prediction, columns=feature_names))
else:
    shap.force_plot(explainer_shap.expected_value[0], shap_values[:, :, 0], pd.DataFrame(features_for_prediction, columns=feature_names))
